...
import 'package:hessflix/util/num_extension.dart';
...
class HessflixSlider extends StatefulWidget {
  final double value;
  final double min;
  final double max;
  final int? divisions;
  ...
  @override
  HessflixSliderState createState() => HessflixSliderState();
}

class HessflixSliderState extends State<HessflixSlider> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant HessflixSlider oldWidget) {
